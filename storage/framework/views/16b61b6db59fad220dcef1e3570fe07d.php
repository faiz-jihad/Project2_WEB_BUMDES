        ...
        <div class="container" data-aos="fade-up">
                            ...
                            <div class="produk-area">
                                ...
                                <div class="produk-info">
                                    ...
                                    <p class="subtotal">Subtotal:
                                        <span>Rp <?php echo e(number_format($item['harga'] * $item['jumlah'], 0, ',', '.')); ?></span>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="sticky-footer">
                    ...
                    <div class="footer-right">
                        <div class="total-text">
                            Total: <span id="totalHargaMobile">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                        </div>
            ...
            <?php else: ?>
                <div class="keranjang-empty">
                    <img src="<?php echo e(asset('images/empty-cart.svg')); ?>" alt="Kosong" class="empty-img">
