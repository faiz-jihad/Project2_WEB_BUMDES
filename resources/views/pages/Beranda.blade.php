            ...
            <div id="fotoKegiatanCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner rounded-3 shadow-sm" style="max-height: 380px; overflow: hidden;">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/gbr.jpg') }}" class="d-block w-100" alt="Penanaman Pohon" />
                    </div>
                    <div class="carousel-item active">
                        <img src="{{ asset('images/gbr2.jpg') }}" class="d-block w-100" alt="Penanaman Pohon" />
                    </div>
                    <div class="carousel-item active">
                        <img src="{{ asset('images/gbr3.jpg') }}" class="d-block w-100" alt="Penanaman Pohon" />
                    </div>
