    ...
    <body>
        ...
        <div class="container my-4 position-relative" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
            ...
            <div class="position-relative rounded-3 overflow-hidden shadow-sm" style="min-height: 420px;">
                <!-- Background -->
                <img src="{{ asset('images/bg2.jpg') }}" alt="Pemandangan Sawah" class="w-100 h-100 object-fit-cover" />
            ...
            {{-- <div
                class="partner-logos d-flex justify-content-center align-items-center gap-4 bg-white shadow-sm mt-5 p-3 rounded-3">
                <img src="{{ asset('images/bumn.png') }}" alt="BUMN" />
                <img src="{{ asset('images/bumdes.jpg') }}"alt="Madusari Logo" />
                <img src="{{ asset('images/ikatan.jpg') }}" alt="Agribisnis" />
                <img src="{{ asset('images/masyarakat.jpg') }}"alt="Pemuda" />
            </div> --}}
        </div>
                ...
                <div id="beritaWrapper" class="d-flex transition">
                    ...
                    <div class="col-12 col-md-4 flex-shrink-0 px-2">
                        <div class="card border-0">
                            <img src="{{ asset('images/bg2.jpg') }}" class="card-img-top rounded-3" alt="Panen Padi" />
                    ...
                    <div class="col-12 col-md-4 flex-shrink-0 px-2">
                        <div class="card border-0">
                            <img src="{{ asset('images/bg2.jpg') }}" class="card-img-top rounded-3"
                                alt="Peternakan Lele" />
                            <div class="card-body p-0 mt-2">
        ...
        <div class="container my-5 text-center partner-logos">
            ...
            <div class="d-flex justify-content-center align-items-center gap-5 flex-wrap">
                <img src="{{ asset('images/bumn.png') }}" alt="BUMN" />
                <img src="{{ asset('images/bumdes.jpg') }}" alt="Bulog" />
                <img src="{{ asset('images/masyarakat.jpg') }}" alt="Kemenko Perekonomian" style="height: 110px" />
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                        <img src="{{ asset('images/bg2.jpg') }}" class="card-img-top" alt="Beras" />
                        <div class="card-price">Beras<br>10.000</div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                        <img src="{{ asset('images/bg2.jpg') }}" class="card-img-top" alt="Lele" />
                        <div class="card-price">Lele<br>10.000</div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                        <img src="{{ asset('images/bg2.jpg') }}" class="card-img-top" alt="Tanaman Hias" />
            ...
            <div id="fotoKegiatanCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner rounded-3 shadow-sm" style="max-height: 380px; overflow: hidden;">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/bg2.jpg') }}" class="d-block w-100" alt="Penanaman Pohon" />
                    </div>
                    <div class="carousel-item active">
                        <img src="{{ asset('images/bg2.jpg') }}" class="d-block w-100" alt="Penanaman Pohon" />
                    </div>
